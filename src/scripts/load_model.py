...
model.load_state_dict(torch.load("../../states/24_04_05__15_40_46/tinyVgg.pth", map_location=torch.device("cpu")))
...
# img = cv2.imread("../../data/train/images/020.jpg")
# img = cv2.imread("../../data/test/images/111.jpg")
img = cv2.imread("test_images/vivi_resized.jpg")
...
with torch.inference_mode():
    ...
    plot_prediction(img_tensor, y_pred.cpu().squeeze(dim=0))
